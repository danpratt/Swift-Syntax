...
print("2nd: \(admitted[1]) 3rd: \(admitted[2])")
...
var foodDictionary = ["Anchovies": false, "Coconut": true, "Cilantro": true, "Liver": false]
...
if let bushDogName = presidentialPetsDict.removeValue(forKey: "George Bush") {
    presidentialPetsDict.updateValue(bushDogName, forKey: "George W. Bush")
}
...
if let obamaDog = presidentialDogs["Barack Obama"] {
    print("Michele Obama walks \(obamaDog) every morning.")
} else {
    print("Guess they don't have a dog...")
}
